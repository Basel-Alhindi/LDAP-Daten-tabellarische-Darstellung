...
$count= $gruppenRepository->zaehleGruppen(GruppenRepository::GRUPPEN_ART_GIT, $suchbegriff);
$gruppe_name= $gruppenRepository->findeGruppen(GruppenRepository::GRUPPEN_ART_GIT,$suchbegriff,$sort);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div id="main" align="center">
        ...
        <div id="sucheOben" align="center">
            <form action="jira.php" method="get" target="_self">
                <p>Hier können Sie alle Git Gruppen durchsuchen:</p>
        ...
        <div id="tabelle">
            <table>
                <tr onclick="location.href='git.php?<?php if (isset($_GET["searchitem"])){echo"searchitem=".$_GET["searchitem"];}echo "&sort=".$sort?>'">
                    <th >Nr:</th>
                    <th>Loginname:</th>
                    <th >Mitglieder</th>
                </tr>
